...
export const defaultLayers = {
	...
	southFacingHead1: { // You can replace this ID with something legible, as long as it's different from all others in the file.
		visible: false,
		type: layerTypes.VECTOR,
		url: '/static/geo/Down-Head-X-S.geojson',
		displayName: 'West Head (South Oriented) (left)', // michele-ver-29.svg-geoEquirectangular
		preserveOriginalStyle: false,
		style: {
			lineWidth: 1,
			color: 'rgba(255, 255, 255, 1)',
	...
	southFacingHead2: { // You can replace this ID with something legible, as long as it's different from all others in the file.
		visible: false,
		type: layerTypes.VECTOR,
		url: '/static/geo/Down-Head.geojson',
		displayName: 'West Head (South Oriented) x 2 (left)', // michele-ver-29.svg-geoEquirectangular
		preserveOriginalStyle: false,
		style: {
			lineWidth: 1,
			color: 'rgba(255, 255, 255, 1)',
